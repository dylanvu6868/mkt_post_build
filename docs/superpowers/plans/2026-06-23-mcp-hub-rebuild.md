...
Create `backend/app/mcp/calendar/tools.py` with the full router (CRUD items, status transitions with validation, overview aggregation). See Task 4 in the design spec for endpoint details.
