...
export function ChatSidebar() {
  ...
  return (
    <>
      ...
      <aside className={cn(
        "flex h-screen w-[280px] flex-col border-r border-border bg-background/95 backdrop-blur-2xl transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]",
