...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Gói dịch vụ", href: "/admin/plans", icon: "plans" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "AI Orchestration", href: "/admin/ai-orchestration", icon: "ai" },
    ],
  },
  {
    title: "Hệ thống",
...
const ICONS: Record<string, React.ReactNode> = {
  ...
  ai: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a4 4 0 0 0-4 4v2H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2h-2V6a4 4 0 0 0-4-4z"/><circle cx="9" cy="15" r="1"/><circle cx="15" cy="15" r="1"/></svg>,
