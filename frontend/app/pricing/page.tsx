...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Vitba Lab: Email, SEO, Content Calendar", included: true },
      { text: "Gửi 100 email / ngày", included: true },
      { text: "10 dự án · 5 Brand Voice · 30 KB", included: true },
      { text: "Vitba Tool 10 lượt / ngày · Lịch sử 30 ngày", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Vitba Lab đầy đủ (cả 5 công cụ)", included: true },
      { text: "Gửi 500 email / ngày · 20 Landing AI / ngày", included: true },
      { text: "30 dự án · 15 Brand Voice · 100 KB", included: true },
      { text: "Vitba Tool 30 lượt / ngày · Lịch sử 90 ngày", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Vitba Lab đầy đủ, không giới hạn", included: true },
