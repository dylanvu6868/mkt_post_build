...
const PLANS = [
  {
    ...
    badge: null,
    features: [
      { text: "3 bài viết / ngày", included: true },
      { text: "1 Brand Voice", included: true },
      { text: "5 tài liệu KB", included: true },
  ...
  },
  {
    ...
    badge: "Phổ biến nhất",
    features: [
      { text: "20 bài viết / ngày", included: true },
      { text: "5 Brand Voice", included: true },
      { text: "50 tài liệu KB", included: true },
      { text: "SEO nâng cao", included: true },
      { text: "Lịch sử 90 ngày", included: true },
      { text: "5 Landing Page / tháng", included: true },
