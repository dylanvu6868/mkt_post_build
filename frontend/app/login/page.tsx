              ...
              <div className="w-full flex items-center justify-center gap-4">
                {googleClientId && (
                  <button
                    ...
                    className="w-12 h-12 rounded-full bg-muted border border-border hover:bg-accent hover:border-yellow-500/30 hover:shadow-[0_0_15px_rgba(234,179,8,0.15)] transition-all duration-300 flex items-center justify-center disabled:opacity-50 group"
