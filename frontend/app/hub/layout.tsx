...
const NAV = [
  ...
  { label: "Email", href: "/hub/email", icon: "email" },
  { label: "Insights", href: "/hub/insights", icon: "insights" },
];
...
const ICONS: Record<string, React.ReactNode> = {
  ...
  insights: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>,
